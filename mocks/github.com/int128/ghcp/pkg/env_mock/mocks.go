...
// Chdir provides a mock function for the type MockInterface
func (_mock *MockInterface) Chdir(dir string) error {
...
func (_c *MockInterface_Chdir_Call) Return(err error) *MockInterface_Chdir_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockInterface_Chdir_Call) RunAndReturn(run func(dir string) error) *MockInterface_Chdir_Call {
	_c.Call.Return(run)
	return _c
}

// Getenv provides a mock function for the type MockInterface
func (_mock *MockInterface) Getenv(key string) string {
...
func (_c *MockInterface_Getenv_Call) Return(s string) *MockInterface_Getenv_Call {
	_c.Call.Return(s)
	return _c
}

func (_c *MockInterface_Getenv_Call) RunAndReturn(run func(key string) string) *MockInterface_Getenv_Call {
	_c.Call.Return(run)
	return _c
}
