...
func (_mock *MockInterface) Do(ctx context.Context, in gitobject.Input) (*gitobject.Output, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, gitobject.Input) (*gitobject.Output, error)); ok {
		return returnFunc(ctx, in)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, gitobject.Input) *gitobject.Output); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, gitobject.Input) error); ok {
...
func (_c *MockInterface_Do_Call) Run(run func(ctx context.Context, in gitobject.Input)) *MockInterface_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 gitobject.Input
		if args[1] != nil {
			arg1 = args[1].(gitobject.Input)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockInterface_Do_Call) Return(output *gitobject.Output, err error) *MockInterface_Do_Call {
	_c.Call.Return(output, err)
	return _c
}

func (_c *MockInterface_Do_Call) RunAndReturn(run func(ctx context.Context, in gitobject.Input) (*gitobject.Output, error)) *MockInterface_Do_Call {
	_c.Call.Return(run)
	return _c
}
