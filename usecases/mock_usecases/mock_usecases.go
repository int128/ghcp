...
// Source: github.com/int128/ghcp/usecases/interfaces (interfaces: UpdateBranch,CreateBranch,Commit)
...
func (m *MockUpdateBranch) Do(arg0 context.Context, arg1 interfaces.UpdateBranchIn) error {
...
// Do mocks base method
func (m *MockCreateBranch) Do(arg0 context.Context, arg1 interfaces.CreateBranchIn) error {
	ret := m.ctrl.Call(m, "Do", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Do mocks base method
func (m *MockCommit) Do(arg0 context.Context, arg1 interfaces.CommitIn) (*interfaces.CommitOut, error) {
	ret := m.ctrl.Call(m, "Do", arg0, arg1)
	ret0, _ := ret[0].(*interfaces.CommitOut)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
